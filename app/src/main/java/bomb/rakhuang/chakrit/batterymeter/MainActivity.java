...
import bomb.rakhuang.chakrit.batterymeter.fonts.RobotoBoldTypeface;
import bomb.rakhuang.chakrit.batterymeter.fonts.RobotoLightTypeface;
...
public class MainActivity extends Activity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mWifiEnabled = findViewById(R.id.wifiEnableButton);
        mBatteryEnabled = findViewById(R.id.batteryEnableButton);
        mNotificationsEnabled = findViewById(R.id.notificationsEnableButton);
        mSetWallpaperBtn = findViewById(R.id.choseWallpaperButton);
